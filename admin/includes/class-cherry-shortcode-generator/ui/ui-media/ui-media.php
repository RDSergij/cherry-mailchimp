		...
		public function render() {
			...
			$img_style = ! $this->settings['value'] ? 'style="display:none;"' : '' ;
							...
							foreach ($medias as $medias_key => $medias_value) {
								...
								$html .= '<div class="cherry-image-wrap">';
									$html .= '<div class="inner">';
										$html .= '<div class="preview-holder"  data-id-attr="' . $medias_value . '">';
				...
				$html .= '<div class="cherry-element-wrap">';
					$html .= '<input type="hidden" id="' . $this->settings['id'] . '" class="cherry-upload-input" name="' . $this->settings['name'] . '" value="' . esc_html( $this->settings['value'] ) . '" >';
					$html .= '<input type="button" class="upload-button button-default_" value="' . $this->settings['upload_button_text'] . '" data-title="' . $this->settings['upload_button_text'] . '" data-multi-upload="' . $this->settings['multi_upload'] . '" data-library-type="' . $this->settings['library_type'] . '"/>';
