		...
		public function render() {
			...
			$html .= '<div class="cherry-slider-wrap">';
				...
				$html .= '<div class="cherry-slider-holder">';
					$html .= '<div class="cherry-slider-unit" data-left-limit="' . esc_html( $this->settings['min_value'] ) . '" data-right-limit="' . esc_html( $this->settings['max_value'] ) . '" data-value="' . esc_html( $this->settings['value'] ) . '"></div>';
				$html .= '</div>';
